...
let csrf='',state={};const sensitive=new Set(['QQ_APP_SECRET','STEAM_API_KEY']);const labels={QQ_APP_ID:'QQ AppID',QQ_APP_SECRET:'QQ AppSecret',STEAM_API_KEY:'Steam API Key',STEAM_MONITOR_ENABLED:'Steam 自动监测（保持 false）',GIFT_API_BASE_URL:'礼包网站地址',TRICKCAL_WEB_PUBLIC_URL:'蜡笔板公网地址',TRICKCAL_WEB_SECURE_COOKIE:'蜡笔板 Secure Cookie',TRICKCAL_WEB_SESSION_DAYS:'网页登录保存天数',TRICKCAL_LOGIN_TICKET_MINUTES:'网页登录票据分钟数'};
