...
let csrf='',state={};const sensitive=new Set(['QQ_APP_SECRET','TRICKCAL_BOT_API_KEY']);const labels={QQ_APP_ID:'QQ AppID',QQ_APP_SECRET:'QQ AppSecret',GIFT_API_BASE_URL:'礼包网站地址',TRICKCAL_MODE:'蜡笔板模式',TRICKCAL_API_BASE_URL:'蜡笔板网站地址',TRICKCAL_BOT_API_KEY:'蜡笔板 Bot API Key',TRICKCAL_WEB_PUBLIC_URL:'Legacy 蜡笔板公网地址',TRICKCAL_WEB_SECURE_COOKIE:'Legacy Secure Cookie',TRICKCAL_WEB_SESSION_DAYS:'Legacy 网页保存天数',TRICKCAL_LOGIN_TICKET_MINUTES:'Legacy 网页票据分钟数',MAJSOUL_DATA_MODE:'雀魂数据模式',MAJSOUL_DATA_API_BASE_URL:'雀魂自建数据 API 地址'};
